...
trust_df <-
  tibble(
    id = query_urls |>
      ...
      pull(id),
    sheet = rep("Table 2", 34),
    number_of_areas = c(120, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119,
                        119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 119, 118, 119),
    range = c(
      "C59:CP179", "C59:CS178", "C59:CS178", "C58:CP177", "C58:CS177", "C58:CP177",
      "C58:CS177", "C58:CS177", "C58:CM177", "C58:CS177", "C58:CP177", "C58:CS177",
      "C58:CP177", "C58:CS177", "C58:CS177", "C58:CP177", "C58:CS177", "C58:CP177",
      "C58:CS177", "C58:CS177", "C58:CJ177", "C58:CS177", "C58:CP177", "C58:CS177",
      "C58:CP177", "C58:CS177", "C58:CS177", "C58:CP177", "C58:CS177", "C58:CP177",
      "C58:CS177", "C58:CS177", "C58:CJ176", "C58:CS177"
    ),
    date_start = c(
    ...
    days = c(30, 31, 31, 30, 31, 30, 31, 31, 29, 31, 30, 31, 30, 31, 31, 30, 31,
...
icb_df <-
  tibble(
    id = query_urls |>
      ...
      pull(id),
    sheet = rep("Table 2", 34),
    number_of_areas = c(42, 42, 42, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41,
                        41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41),
    range = c(
      "C15:CP57", "C15:CS57", "C15:CS57", "C15:CP56", "C15:CS56", "C15:CP56", "C15:CS56",
      "C15:CS56", "C15:CM56", "C15:CS56", "C15:CP56", "C15:CS56","C15:CP56", "C15:CS56",
      "C15:CS56", "C15:CP56", "C15:CS56", "C15:CP56", "C15:CS56", "C15:CS56", "C15:CJ56",
      "C15:CS56", "C15:CP56", "C15:CS56", "C15:CP56", "C15:CS56", "C15:CS56", "C15:CP56",
      "C15:CS56", "C15:CP56", "C15:CS56", "C15:CS56", "C15:CJ56", "C15:CS56"
    ),
    date_start = c(
      "2023-06-01", "2023-07-01", "2023-08-01", "2023-09-01", "2023-10-01",
      "2023-11-01", "2023-12-01", "2024-01-01", "2024-02-01", "2024-03-01",
